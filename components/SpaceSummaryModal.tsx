...
const SpaceSummaryModal: React.FC<SpaceSummaryModalProps> = ({
  summary,
  onClose,
  isLoading,
  spaceName,
    ...
    >
      ...
      >
        <header className="p-4 border-b border-[var(--border-primary)] flex justify-between items-center sticky top-0 bg-[var(--bg-secondary)]/80 backdrop-blur-sm z-10 rounded-t-3xl">
          <h2 className="text-xl font-bold themed-title flex items-center gap-2">
            <SparklesIcon className="w-6 h-6" />
            סיכום AI עבור &ldquo;{spaceName}&rdquo;
          </h2>
          <button
            onClick={onClose}
        ...
        <div className="p-6 overflow-y-auto flex-grow">
          {isLoading ? (
            <div className="flex flex-col justify-center items-center h-full text-center text-[var(--text-secondary)]">
              ...
              <p>הבינה המלאכותית מנתחת את התוכן במרחב...</p>
...
export default SpaceSummaryModal;
